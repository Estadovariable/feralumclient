...
const Oxxo = () => {
  ...
  const [subsistema, setSubsistema] = useState('Oxxo');
  ...
  const [ubicacion4, setUbicacion4] = useState("Horizontal inf N fija");
  const [ubicacion5, setUbicacion5] = useState("Horizontal inf N movil");
  const [ubicacion6, setUbicacion6] = useState("Horizontal supe N fija");
  const [ubicacion7, setUbicacion7] = useState("Traslape Fijo");
  const [ubicacion8, setUbicacion8] = useState("Traslape Nave");
  const [ubicacion9, setUbicacion9] = useState("Enganche Fijo");
  const [ubicacion10, setUbicacion10] = useState("Enganche movil");
  const [ubicacion11, setUbicacion11] = useState("Adaptador");
  ...
  const [referencia3, setReferencia3] = useState("ALN 841");
  const [referencia4, setReferencia4] = useState("ALN 157");
  const [referencia5, setReferencia5] = useState("ALN 157");
  const [referencia6, setReferencia6] = useState("ALN 156");
  const [referencia7, setReferencia7] = useState("ALN 190");
  const [referencia8, setReferencia8] = useState("ALN 190");
  const [referencia9, setReferencia9] = useState("ALN 191");
  const [referencia10, setReferencia10] = useState("ALN 191");
  const [referencia11, setReferencia11] = useState("ALN 158");
  ...
  const [cantidadPerfiles11, setCantidadPerfiles11] = useState('1');
  ...
  const [descuento3, setDescuento3] = useState('');
  const [descuento4, setDescuento4] = useState('');
  const [descuento5, setDescuento5] = useState('');
  const [descuento6, setDescuento6] = useState('');
  const [descuento7, setDescuento7] = useState('');
  ...
  const [referenciaAccesorio1, setReferenciaAccesorio1] = useState("");
  const [referenciaAccesorio2, setReferenciaAccesorio2] = useState("");
  const [referenciaAccesorio3, setReferenciaAccesorio3] = useState("");
  ...
  const [cantidadAccesorio1, setCantidadAccesorio1] = useState('');
  const [cantidadAccesorio2, setCantidadAccesorio2] = useState('');
  const [cantidadAccesorio3, setCantidadAccesorio3] = useState('');
  const [cantidadAccesorio4, setCantidadAccesorio4] = useState('');
  const [cantidadAccesorio5, setCantidadAccesorio5] = useState('');
  const [cantidadAccesorio6, setCantidadAccesorio6] = useState('');
  ...
  const [especificacion1, setEspecificacion1] = useState("");
  const [especificacion2, setEspecificacion2] = useState("");
