...
const Ox_desiguales = () => {
  ...
  const [sistema, setSistema] = useState('8025');
  const [subsistema, setSubsistema] = useState('Ox desiguales');
  ...
  const [ubicacion1, setUbicacion1] = useState("Sillar");
  const [ubicacion2, setUbicacion2] = useState("Cabezal");
  const [ubicacion3, setUbicacion3] = useState("Jamba");
  const [ubicacion4, setUbicacion4] = useState("Horizontal Nave inf");
  const [ubicacion5, setUbicacion5] = useState("Horizontal Nave sup");
  const [ubicacion6, setUbicacion6] = useState("Traslape");
  const [ubicacion7, setUbicacion7] = useState("Traslape Nave");
  const [ubicacion8, setUbicacion8] = useState("");
  const [ubicacion9, setUbicacion9] = useState("");
  const [ubicacion10, setUbicacion10] = useState("");
  const [ubicacion11, setUbicacion11] = useState("");
  const [ubicacion12, setUbicacion12] = useState('');
  const [referencia1, setReferencia1] = useState("ALN 150");
  const [referencia2, setReferencia2] = useState("ALN 151");
  const [referencia3, setReferencia3] = useState("ALN 152");
  const [referencia4, setReferencia4] = useState("ALN 157");
  const [referencia5, setReferencia5] = useState("ALN 156");
  const [referencia6, setReferencia6] = useState("ALN 190");
  const [referencia7, setReferencia7] = useState("ALN 191");
  const [referencia8, setReferencia8] = useState("");
  const [referencia9, setReferencia9] = useState("");
  const [referencia10, setReferencia10] = useState("");
  const [referencia11, setReferencia11] = useState("");
  ...
  const [cantidadPerfiles6, setCantidadPerfiles6] = useState('2');
  const [cantidadPerfiles7, setCantidadPerfiles7] = useState('2');
  const [cantidadPerfiles8, setCantidadPerfiles8] = useState('');
  const [cantidadPerfiles9, setCantidadPerfiles9] = useState('');
  const [cantidadPerfiles10, setCantidadPerfiles10] = useState('');
  const [cantidadPerfiles11, setCantidadPerfiles11] = useState('');
  ...
  const [descuento3, setDescuento3] = useState('11');
  const [descuento4, setDescuento4] = useState('3');
  const [descuento5, setDescuento5] = useState('3');
  const [descuento6, setDescuento6] = useState('25');
  const [descuento7, setDescuento7] = useState('25');
  const [descuento8, setDescuento8] = useState('');
  const [descuento9, setDescuento9] = useState('');
  const [descuento10, setDescuento10] = useState('');
  const [descuento11, setDescuento11] = useState('');
  ...
  const [accesorio3, setAccesorio3] = useState("Rodamiento acero");
  const [accesorio4, setAccesorio4] = useState("Guia superior");
  const [accesorio5, setAccesorio5] = useState("Guia inferior nave");
  const [accesorio6, setAccesorio6] = useState("Guia inferior fija");
  const [accesorio7, setAccesorio7] = useState("Chapa impacto doble");
  const [accesorio8, setAccesorio8] = useState("Chapa impacto sencilla");
  const [accesorio9, setAccesorio9] = useState("Topes");
  const [referenciaAccesorio1, setReferenciaAccesorio1] = useState("10 x 1");
  const [referenciaAccesorio2, setReferenciaAccesorio2] = useState("10 x 1 1/2");
  const [referenciaAccesorio3, setReferenciaAccesorio3] = useState("ABB - 37mm (1/2'')");
  const [referenciaAccesorio4, setReferenciaAccesorio4] = useState("8025");
  const [referenciaAccesorio5, setReferenciaAccesorio5] = useState("8025");
  const [referenciaAccesorio6, setReferenciaAccesorio6] = useState("8025");
  const [referenciaAccesorio7, setReferenciaAccesorio7] = useState("8025");
  const [referenciaAccesorio8, setReferenciaAccesorio8] = useState("8025");
  const [referenciaAccesorio9, setReferenciaAccesorio9] = useState('');
  const [cantidadAccesorio1, setCantidadAccesorio1] = useState('8');
  const [cantidadAccesorio2, setCantidadAccesorio2] = useState('8');
  const [cantidadAccesorio3, setCantidadAccesorio3] = useState('2');
  const [cantidadAccesorio4, setCantidadAccesorio4] = useState('4');
  const [cantidadAccesorio5, setCantidadAccesorio5] = useState('2');
  const [cantidadAccesorio6, setCantidadAccesorio6] = useState('2');
  const [cantidadAccesorio7, setCantidadAccesorio7] = useState('1');
  const [cantidadAccesorio8, setCantidadAccesorio8] = useState('');
  const [cantidadAccesorio9, setCantidadAccesorio9] = useState('2');
  const [especificacion1, setEspecificacion1] = useState("Vidrio nave");
  const [especificacion2, setEspecificacion2] = useState("Vidrio nave");
  const [calibre1, setCalibre1] = useState('5');
  const [calibre2, setCalibre2] = useState('5');
