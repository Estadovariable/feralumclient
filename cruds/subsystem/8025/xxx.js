...
const Xxx = () => {
  ...
  const [subsistema, setSubsistema] = useState('Xxx');
  ...
  const [ubicacion4, setUbicacion4] = useState("Horizontal inf");
  const [ubicacion5, setUbicacion5] = useState("Horizontal sup");
  ...
  const [referencia1, setReferencia1] = useState("ALN 706");
  const [referencia2, setReferencia2] = useState("ALN 707");
  const [referencia3, setReferencia3] = useState("ALN 708");
  ...
  const [cantidadPerfiles4, setCantidadPerfiles4] = useState('3');
  const [cantidadPerfiles5, setCantidadPerfiles5] = useState('3');
  ...
  const [descuento4, setDescuento4] = useState('29');
  const [descuento5, setDescuento5] = useState('20');
  const [descuento6, setDescuento6] = useState('29');
  const [descuento7, setDescuento7] = useState('29');
  ...
  const [accesorio8, setAccesorio8] = useState("Felpa 5mm");
  const [accesorio9, setAccesorio9] = useState("Empaques");
  ...
  const [cantidadAccesorio2, setCantidadAccesorio2] = useState('24');
  const [cantidadAccesorio3, setCantidadAccesorio3] = useState('6');
  const [cantidadAccesorio4, setCantidadAccesorio4] = useState('6');
  const [cantidadAccesorio5, setCantidadAccesorio5] = useState('6');
  const [cantidadAccesorio6, setCantidadAccesorio6] = useState('0');
  const [cantidadAccesorio7, setCantidadAccesorio7] = useState('2');
  const [cantidadAccesorio8, setCantidadAccesorio8] = useState('25');
  const [cantidadAccesorio9, setCantidadAccesorio9] = useState('20');
  const [especificacion1, setEspecificacion1] = useState("Crudo");
  const [especificacion2, setEspecificacion2] = useState("Crudo");
  const [calibre1, setCalibre1] = useState('6');
  const [calibre2, setCalibre2] = useState('6');
