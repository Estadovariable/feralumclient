...
const Xo_con_chapa = () => {
  ...
  const [subsistema, setSubsistema] = useState('Xo con chapa');
  ...
  const [ubicacion9, setUbicacion9] = useState("Horizontal sup");
  const [ubicacion10, setUbicacion10] = useState("Horizontal Nave inf");
  const [ubicacion11, setUbicacion11] = useState("Horizontal Nave sup");
  const [ubicacion12, setUbicacion12] = useState('');
  const [referencia1, setReferencia1] = useState("ALN 581");
  ...
  const [descuento8, setDescuento8] = useState('12');
  const [descuento9, setDescuento9] = useState('12');
  const [descuento10, setDescuento10] = useState('17');
  const [descuento11, setDescuento11] = useState('17');
  ...
  const [cantidadAccesorio4, setCantidadAccesorio4] = useState('2850');
