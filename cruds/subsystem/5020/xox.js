...
const Xox = () => {
  ...
  const [sistema, setSistema] = useState('5020');
  const [subsistema, setSubsistema] = useState('Xox');
  ...
  const [ubicacion2, setUbicacion2] = useState("Alfajia");
  const [ubicacion3, setUbicacion3] = useState("Cabezal");
  const [ubicacion4, setUbicacion4] = useState("Jamba");
  const [ubicacion5, setUbicacion5] = useState("Traslape");
  const [ubicacion6, setUbicacion6] = useState("Traslape chapa");
  const [ubicacion7, setUbicacion7] = useState("Enganche movil");
  const [ubicacion8, setUbicacion8] = useState("Enganche Fijo");
  const [ubicacion9, setUbicacion9] = useState("Horizontal Nave sup");
  ...
  const [referencia3, setReferencia3] = useState("ALN 144");
  const [referencia4, setReferencia4] = useState("ALN 193");
  const [referencia5, setReferencia5] = useState("ALN 192");
  const [referencia6, setReferencia6] = useState("ALN 462");
  const [referencia7, setReferencia7] = useState("ALN 147");
  const [referencia8, setReferencia8] = useState("ALN 147");
  ...
  const [cantidadPerfiles3, setCantidadPerfiles3] = useState('1');
  ...
  const [cantidadPerfiles9, setCantidadPerfiles9] = useState('4');
  ...
  const [descuento3, setDescuento3] = useState('0');
  const [descuento4, setDescuento4] = useState('15');
  const [descuento5, setDescuento5] = useState('31');
  const [descuento6, setDescuento6] = useState('31');
  const [descuento7, setDescuento7] = useState('31');
  const [descuento8, setDescuento8] = useState('28');
  const [descuento9, setDescuento9] = useState('12');
  const [descuento10, setDescuento10] = useState('18');
  ...
  const [accesorio3, setAccesorio3] = useState("Cerradura impacto");
  const [accesorio4, setAccesorio4] = useState("Felpas siliconadas");
  const [accesorio5, setAccesorio5] = useState("Empaques");
  const [accesorio6, setAccesorio6] = useState("");
  ...
  const [referenciaAccesorio3, setReferenciaAccesorio3] = useState("De impacto");
  const [referenciaAccesorio4, setReferenciaAccesorio4] = useState("");
  const [referenciaAccesorio5, setReferenciaAccesorio5] = useState("U - 55");
  ...
  const [cantidadAccesorio2, setCantidadAccesorio2] = useState('12');
  const [cantidadAccesorio3, setCantidadAccesorio3] = useState('2');
  const [cantidadAccesorio4, setCantidadAccesorio4] = useState('8954');
  const [cantidadAccesorio5, setCantidadAccesorio5] = useState('8954');
