...
const Xo_liviana_cerradura_cierre = () => {
  const [formulario, setFormulario] = useState({});
  const [sistema, setSistema] = useState('5020');
  const [subsistema, setSubsistema] = useState('Xo liviana cerradura cierre');
  ...
  const [ubicacion3, setUbicacion3] = useState("Jamba nave");
  const [ubicacion4, setUbicacion4] = useState("Jamba fijo");
  const [ubicacion5, setUbicacion5] = useState("Traslape Nave");
  const [ubicacion6, setUbicacion6] = useState("Enganche Nave");
  const [ubicacion7, setUbicacion7] = useState("Enganche Fijo");
  const [ubicacion8, setUbicacion8] = useState("Horizontal Nave sup");
  const [ubicacion9, setUbicacion9] = useState("Horizontal Nave inf");
  const [ubicacion10, setUbicacion10] = useState("Horizontal sup");
  const [ubicacion11, setUbicacion11] = useState("Horizontal inf");
  const [ubicacion12, setUbicacion12] = useState("Maletero");
  const [referencia1, setReferencia1] = useState("ALN 532");
  const [referencia2, setReferencia2] = useState("ALN 531");
  const [referencia3, setReferencia3] = useState("ALN 193");
  const [referencia4, setReferencia4] = useState("ALN 533");
  ...
  const [referencia10, setReferencia10] = useState("ALN 534");
  const [referencia11, setReferencia11] = useState("ALN 534");
  ...
  const [cantidadPerfiles4, setCantidadPerfiles4] = useState('1');
  ...
  const [descuento3, setDescuento3] = useState('16');
  const [descuento4, setDescuento4] = useState('16');
  const [descuento5, setDescuento5] = useState('33');
  const [descuento6, setDescuento6] = useState('33');
  const [descuento7, setDescuento7] = useState('16');
  const [descuento8, setDescuento8] = useState('14');
  const [descuento9, setDescuento9] = useState('14');
  const [descuento10, setDescuento10] = useState('0');
  const [descuento11, setDescuento11] = useState('0');
  ...
  const [cantidadAccesorio4, setCantidadAccesorio4] = useState('1923');
...
export default Xo_liviana_cerradura_cierre;
