...
const Xx_con_cierre_y_chapa = () => {
  const [formulario, setFormulario] = useState({});
  const [sistema, setSistema] = useState('5020');
  const [subsistema, setSubsistema] = useState('Xx con cierre y chapa');
  ...
  const [ubicacion4, setUbicacion4] = useState("Traslape chapa");
  const [ubicacion5, setUbicacion5] = useState("Enganche movil");
  const [ubicacion6, setUbicacion6] = useState("Enganche Fijo");
  const [ubicacion7, setUbicacion7] = useState("Horizontal sup");
  const [ubicacion8, setUbicacion8] = useState("Horizontal inf");
  ...
  const [referencia4, setReferencia4] = useState("ALN 462");
  const [referencia5, setReferencia5] = useState("ALN 147");
  const [referencia6, setReferencia6] = useState("ALN 147");
  const [referencia7, setReferencia7] = useState("ALN 349");
  ...
  const [descuento4, setDescuento4] = useState('31');
  ...
  const [descuento8, setDescuento8] = useState('15');
  const [descuento9, setDescuento9] = useState('15');
  ...
  const [cantidadAccesorio6, setCantidadAccesorio6] = useState('3');
  ...
  const [calibre1, setCalibre1] = useState('0');
  const [calibre2, setCalibre2] = useState('0');
...
export default Xx_con_cierre_y_chapa;
