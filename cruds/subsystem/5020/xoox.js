...
const Xoox = () => {
  ...
  const [subsistema, setSubsistema] = useState('Xoox');
  ...
  const [ubicacion4, setUbicacion4] = useState("Alfajia");
  const [ubicacion5, setUbicacion5] = useState("Jamba");
  const [ubicacion6, setUbicacion6] = useState("Traslape Nave");
  ...
  const [ubicacion10, setUbicacion10] = useState("Horizontal inf");
  ...
  const [referencia2, setReferencia2] = useState("ALN 413");
  const [referencia3, setReferencia3] = useState("ALN 144");
  const [referencia4, setReferencia4] = useState("ALN 1123");
  const [referencia5, setReferencia5] = useState("ALN 193");
  ...
  const [referencia12, setReferencia12] = useState("ALN 349");
  ...
  const [cantidadPerfiles8, setCantidadPerfiles8] = useState('4');
  const [cantidadPerfiles9, setCantidadPerfiles9] = useState('4');
  const [cantidadPerfiles10, setCantidadPerfiles10] = useState('4');
  const [cantidadPerfiles11, setCantidadPerfiles11] = useState('4');
  const [cantidadPerfiles12, setCantidadPerfiles12] = useState('4');
  ...
  const [descuento8, setDescuento8] = useState('68');
  const [descuento9, setDescuento9] = useState('68');
  const [descuento10, setDescuento10] = useState('68');
  const [descuento11, setDescuento11] = useState('68');
  ...
  const [referenciaAccesorio6, setReferenciaAccesorio6] = useState("U - 55");
  ...
  const [cantidadAccesorio6, setCantidadAccesorio6] = useState('10688');
  ...
  const [especificacion1, setEspecificacion1] = useState("Crudo naves");
  const [especificacion2, setEspecificacion2] = useState("Crudo fijo");
