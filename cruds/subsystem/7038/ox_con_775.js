...
const Ox_con_775 = () => {
  ...
  const [subsistema, setSubsistema] = useState('Ox con 775');
  ...
  const [ubicacion4, setUbicacion4] = useState("Horizontal sup");
  const [ubicacion5, setUbicacion5] = useState("Horizontal inf");
  ...
  const [referencia2, setReferencia2] = useState("ALN 775");
  ...
  const [descuento6, setDescuento6] = useState('35');
  const [descuento7, setDescuento7] = useState('35');
  const [descuento8, setDescuento8] = useState('40');
  const [descuento9, setDescuento9] = useState('40');
  ...
  const [especificacion2, setEspecificacion2] = useState("Vidrio fijo");
