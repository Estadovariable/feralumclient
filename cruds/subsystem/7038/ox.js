...
const Ox = () => {
  ...
  const [subsistema, setSubsistema] = useState('Ox');
  ...
  const [ubicacion1, setUbicacion1] = useState("Cabezal");"Cabezal"
  const [ubicacion2, setUbicacion2] = useState("Sillar");
  const [ubicacion3, setUbicacion3] = useState("Jamba");
  const [ubicacion4, setUbicacion4] = useState("Horizontal supe N movil");
  const [ubicacion5, setUbicacion5] = useState("Horizontal supe N fija");
  const [ubicacion6, setUbicacion6] = useState("Traslape Fijo");
  const [ubicacion7, setUbicacion7] = useState("Enganche Fijo");
  const [ubicacion8, setUbicacion8] = useState("Traslape Nave");
  const [ubicacion9, setUbicacion9] = useState("Enganche Nave");
  ...
  const [referencia1, setReferencia1] = useState("ALN 700");
  const [referencia2, setReferencia2] = useState("ALN 701");
  const [referencia3, setReferencia3] = useState("ALN 702");
  const [referencia4, setReferencia4] = useState("ALN 703");
  const [referencia5, setReferencia5] = useState("ALN 703");
  const [referencia6, setReferencia6] = useState("ALN 704");
  const [referencia7, setReferencia7] = useState("ALN 705");
  const [referencia8, setReferencia8] = useState("ALN 704");
  const [referencia9, setReferencia9] = useState("ALN 705");
  ...
  const [cantidadPerfiles4, setCantidadPerfiles4] = useState('4');
  const [cantidadPerfiles5, setCantidadPerfiles5] = useState('4');
  const [cantidadPerfiles6, setCantidadPerfiles6] = useState('1');
  const [cantidadPerfiles7, setCantidadPerfiles7] = useState('1');
  const [cantidadPerfiles8, setCantidadPerfiles8] = useState('1');
  const [cantidadPerfiles9, setCantidadPerfiles9] = useState('1');
  ...
  const [descuento3, setDescuento3] = useState('25');
  const [descuento4, setDescuento4] = useState('7');
  const [descuento5, setDescuento5] = useState('7');
  const [descuento6, setDescuento6] = useState('30');
  const [descuento7, setDescuento7] = useState('30');
  const [descuento8, setDescuento8] = useState('35');
  const [descuento9, setDescuento9] = useState('35');
  ...
  const [referenciaAccesorio2, setReferenciaAccesorio2] = useState("12 x 1 1/2 CAB PAN ACERO");
  const [referenciaAccesorio3, setReferenciaAccesorio3] = useState("Tandem ABB - 7038");
  const [referenciaAccesorio4, setReferenciaAccesorio4] = useState("Guia plastica 7038");
