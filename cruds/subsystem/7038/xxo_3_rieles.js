...
const Xxo_3_rieles = () => {
  ...
  const [subsistema, setSubsistema] = useState('Xxo 3 rieles');
  ...
  const [ubicacion11, setUbicacion11] = useState("Enganche nave 3");
  ...
  const [descuento7, setDescuento7] = useState('32');
  const [descuento8, setDescuento8] = useState('32');
  ...
  const [accesorio5, setAccesorio5] = useState("Cerradura overseas");
  ...
  const [cantidadAccesorio6, setCantidadAccesorio6] = useState('40');
  const [cantidadAccesorio7, setCantidadAccesorio7] = useState('15');
