...
const Xxx_3_rieles = () => {
  ...
  const [subsistema, setSubsistema] = useState('Xxx 3 rieles');
  ...
  const [ubicacion4, setUbicacion4] = useState("Horizontal supe E inf nave 2");
  const [ubicacion5, setUbicacion5] = useState("Traslape nave1");
  const [ubicacion6, setUbicacion6] = useState("Enganche nave 1 y 2");
  const [ubicacion7, setUbicacion7] = useState("Traslape nave 3");
  const [ubicacion8, setUbicacion8] = useState("Enganche nave 3");
  ...
  const [referencia1, setReferencia1] = useState("ALN 1730");
  const [referencia2, setReferencia2] = useState("ALN 1729");
  const [referencia3, setReferencia3] = useState("ALN 1731");
  const [referencia4, setReferencia4] = useState("ALN 703");
  const [referencia5, setReferencia5] = useState("ALN 704");
  const [referencia6, setReferencia6] = useState("ALN 705");
  const [referencia7, setReferencia7] = useState("ALN 704");
  const [referencia8, setReferencia8] = useState("ALN 705");
  ...
  const [cantidadPerfiles4, setCantidadPerfiles4] = useState('6');
  const [cantidadPerfiles5, setCantidadPerfiles5] = useState('1');
  const [cantidadPerfiles6, setCantidadPerfiles6] = useState('3');
  const [cantidadPerfiles7, setCantidadPerfiles7] = useState('1');
  const [cantidadPerfiles8, setCantidadPerfiles8] = useState('1');
  ...
  const [descuento4, setDescuento4] = useState('15');
  const [descuento5, setDescuento5] = useState('37');
  const [descuento6, setDescuento6] = useState('37');
  const [descuento7, setDescuento7] = useState('37');
  const [descuento8, setDescuento8] = useState('37');
  ...
  const [accesorio5, setAccesorio5] = useState("Felpa 5mm");
  ...
  const [referenciaAccesorio1, setReferenciaAccesorio1] = useState("12 x 1 1/2 CAB PAN");
  const [referenciaAccesorio2, setReferenciaAccesorio2] = useState("12 x 1 1/2 CAB PAN");
  const [referenciaAccesorio3, setReferenciaAccesorio3] = useState("Tandem");
  const [referenciaAccesorio4, setReferenciaAccesorio4] = useState("");
  const [referenciaAccesorio5, setReferenciaAccesorio5] = useState("Pico loro");
  const [referenciaAccesorio6, setReferenciaAccesorio6] = useState("");
  const [referenciaAccesorio7, setReferenciaAccesorio7] = useState("U - 15");
  const [referenciaAccesorio8, setReferenciaAccesorio8] = useState('');
  const [referenciaAccesorio9, setReferenciaAccesorio9] = useState('');
  const [cantidadAccesorio1, setCantidadAccesorio1] = useState('24');
  const [cantidadAccesorio2, setCantidadAccesorio2] = useState('8');
  const [cantidadAccesorio3, setCantidadAccesorio3] = useState('6');
  const [cantidadAccesorio4, setCantidadAccesorio4] = useState('6');
  const [cantidadAccesorio5, setCantidadAccesorio5] = useState('2');
  const [cantidadAccesorio6, setCantidadAccesorio6] = useState('60');
  const [cantidadAccesorio7, setCantidadAccesorio7] = useState('25');
  const [cantidadAccesorio8, setCantidadAccesorio8] = useState('');
  const [cantidadAccesorio9, setCantidadAccesorio9] = useState('');
  const [especificacion1, setEspecificacion1] = useState("Crudo");
  const [especificacion2, setEspecificacion2] = useState("Crudo");
  const [calibre1, setCalibre1] = useState('');
  const [calibre2, setCalibre2] = useState('');
